 ...
 * Please note that this class is almost identical to the example Server class found on Studres. The principal
 * difference between this Server class and the one on StudRes is that this one is multithreaded.
...
public class Server {
     ...
     * object using the Socket object, and calls the start method, which then calls the ConnectionHandler's run method.
